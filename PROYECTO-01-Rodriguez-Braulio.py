...
def conclusion():
    #este metodo imprimira la conclusion del programa y decir que producto son los mas vendidos, con las mejores reseñas y con los menos vendidos y peores reseñas
    ...
    productos_vendidos = []
    #relacionamos los productos con reseñas con el id de los productos en las ventas
    for producto in productos:
